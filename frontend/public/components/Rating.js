    ...
    render: (props) => {
        ...
        <div class="relative ">
            <div class="flex">
                ...
                <div class="fill-lime-400">
                    <?xml version="1.0" encoding="UTF-8"?>
                    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" class="w-4">
                        <path
            ...
            <div class="flex absolute top-0 left-0 z-10 w-0 h-full overflow-hidden" style=" width:${
                props.value * 20
            }%">

                <div class="fill-lime-400">
                    <?xml version="1.0" encoding="UTF-8"?>
                    <svg xmlns="http://www.w3.org/2000/svg" id="Filled" viewBox="0 0 24 24" class="w-4">
                        <path
